...
import 'lista_ordenes_model.dart';
export 'lista_ordenes_model.dart';

class ListaOrdenesWidget extends StatefulWidget {
  const ListaOrdenesWidget({Key? key}) : super(key: key);

  @override
  _ListaOrdenesWidgetState createState() => _ListaOrdenesWidgetState();
}

class _ListaOrdenesWidgetState extends State<ListaOrdenesWidget> {
  late ListaOrdenesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaOrdenesModel());
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<OrdenesRecord>>(
                                    stream: queryOrdenesRecord(
                                      queryBuilder: (ordenesRecord) =>
                                          ordenesRecord.where('userRef',
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewOrdenesRecordList.length,
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Slidable(
                                            ...
                                            child: ListTile(
                                              ...
                                              subtitle: Text(
                                                listViewOrdenesRecord.fechaHora!
                                                    .toString(),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .titleSmall,
