...
export 'lista_medicamentos_model.dart';

class ListaMedicamentosWidget extends StatefulWidget {
  const ListaMedicamentosWidget({Key? key}) : super(key: key);

  @override
  _ListaMedicamentosWidgetState createState() =>
      _ListaMedicamentosWidgetState();
}

class _ListaMedicamentosWidgetState extends State<ListaMedicamentosWidget> {
  late ListaMedicamentosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaMedicamentosModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Visibility(
            visible: valueOrDefault(currentUserDocument?.roles, '') == 'admin',
            child: Padding(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'qqp2r86y' /* Seleccione una opción del menú */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
